...
public class MonthlyExpense extends javax.swing.JFrame {
    ...
    private void showItems() {
    	text.setText(this.inventory.monthlyExpense());
    }
...
//        jLabel3.setText("Quantity");
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(MonthlyExpense.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new MonthlyExpense().setVisible(true);
        });
    }
