...
import restaurantInventorySystem.Item;
...
public class UpdateItem extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Enter new Unit of Measurement");
...
//        jLabel7.setText("Price");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(unitM, javax.swing.GroupLayout.PREFERRED_SIZE, 107, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        String unit = unitM.getText();

        if (srcName.isEmpty() || modName.isEmpty() || modPrice.isEmpty() || modQuantity.isEmpty() || unit.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Field(s) cannot be left empty");
            return;
        }

        if (Double.parseDouble(modPrice) <= 0) {
            JOptionPane.showMessageDialog(this, "Please enter a valid price for the item");
            return;
        }

        if (Integer.parseInt(modQuantity) <= 0 ||!modQuantity.chars().allMatch(Character::isDigit)) {
            JOptionPane.showMessageDialog(this, "Please enter a valid quantity for the item");
            return;
        }
        String type = this.inventory.getItemType(srcName);
        Item item;
        if (type.equalsIgnoreCase("ingredient")) {
        	this.inventory.setIngredient();
        	item = this.inventory.item(modName, Integer.parseInt(modQuantity), unit, Double.parseDouble(modPrice));
        } else {
        	this.inventory.setConsumable();
        	item = this.inventory.item(modName, Integer.parseInt(modQuantity), unit, Double.parseDouble(modPrice));
        }
        
        boolean isUpdated = this.inventory.updateItem(item, srcName);
